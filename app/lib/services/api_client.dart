...
class ApiClient {
  ...
  Future<User> register({
    ...
    try {
      ...
      throw UnimplementedError(
        'Register endpoint not yet implemented in backend',
      );
    } catch (e) {
      if (e is ApiException) rethrow;
  ...
  Future<void> resetPassword({required String email}) async {
    try {
      // Placeholder - backend endpoint needs to be implemented
      throw UnimplementedError(
        'Password reset endpoint not yet implemented in backend',
      );
    } catch (e) {
      if (e is ApiException) rethrow;
  ...
  Future<Map<String, List<Event>>> getUserEvents(int userId) async {
    try {
      ...
      return {'organized': organized, 'attending': attending};
    } catch (e) {
      if (e is ApiException) rethrow;
  ...
  Future<void> confirmAttendance({
    ...
    try {
      await http.post(
        ...
        headers: _getHeaders(),
        body: json.encode({'id_usuario': userId, 'estado': 'CONFIRMADA'}),
      );
    } catch (e) {
      if (e is ApiException) rethrow;
