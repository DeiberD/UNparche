...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _register() async {
    ...
    try {
      ...
      if (mounted) {
        Navigator.pop(context); // Regresa a la pantalla principal o la anterior tras login exitoso
      }
    } catch (e) {
      if (mounted) {
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    if (!value.endsWith('@unal.edu.co')) return 'Debe ser un correo @unal.edu.co';
                    return null;
                  },
                ),
                const SizedBox(height: 16),
